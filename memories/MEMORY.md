OpenClaw 2026.7.2(18789,手动更新);node22.22.3+pnpm11.15.1;交互:export PATH加22.22.3后 pnpm openclaw agent -m 'x'。
§
...
§
用户 2026 电赛 G 题(仪器仪表)省一候选;若进邀请赛:决赛8/23-27武汉全封闭,命题=模拟信号获取/处理/转换/产生+变流;预案:作战手册+一键脚本>断网演练>本地小模型+RAG(Nano 1-3B,现场参谋非codex平替);开发靠codex SSH上Nano写C++/CUDA/Qt5。
§
...
§
MX450驱动已修(nvidia-smi正常);ollama-cuda已装,2G显存跑3B模型加速有限。
§
